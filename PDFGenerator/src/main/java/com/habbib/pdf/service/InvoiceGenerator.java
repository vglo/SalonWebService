...
public class InvoiceGenerator {
	...
	public void createPDF (Bill billObj,Customerinfo customer,String pdfFilename){
		...
		try {
			...
			Paragraph name = new Paragraph(customer.getFirstName()+" "+customer.getLastName());
			name.setIndentationLeft(20);
			Paragraph contact = new Paragraph(customer.getMobile());
			contact.setIndentationLeft(20);
			Paragraph address = new Paragraph(customer.getAddress());
			...
			document.open();//PDF document opened........	
			  // Add the header
			/*
			 * document.add( new Paragraph() .add(o) .setMultipliedLeading(1) .add(new
			 * Text(String.format("%s %s\n", "INVOICE", "123456"))
			 * .setFont(bold).setFontSize(14)) .add(LocalDate.now()));
			 */
